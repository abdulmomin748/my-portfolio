        ...
        <>
            <section className="section skills-sec" id='skills'>
                <div className="container">
                    <h2 className="exp-ttle mb-10 text-5xl font-semibold  section-title relative pb-4">Skills</h2>
                    <div data-aos="fade-right" data-aos-duration="1000" className="experience-cntlr flex lg:px-20 md:px-14 px-10">
                        ...
                        <div className="exp-lft w-full ml-auto pl-14 border-[#f57820] border-l-2 relative py-8">
                            ...
                            <div className="lg:w-1/4 w-2/4 -ml-4 mt-4 bg-gray-200 rounded-full dark:bg-gray-700">
                                <div className={`text-[10px] font-medium text-white py-[1px] text-center leading-none rounded-full transition-[1s] w-[80%] bg-[#f57820]`}></div>
                            </div>

                        </div>
                    </div>
                    <div  data-aos="fade-left" data-aos-duration="1000" className="experience-cntlr flex order-row lg:py-15 md:py-10 py-10 lg:px-15 md:px-10 px-5">
                        ...
                        <div className="exp-lft lg:pr-14 md:pr-12 pr-10 py-8 w-full order-1 border-[#f57820] border-r-2 relative">
                            <div className=' ml-auto'>
                                ...
                                <div className="lg:w-1/4 md:w-2/4 w-2/4  ml-auto  mt-4 bg-gray-200 rounded-full dark:bg-gray-700">
                                    <div className={`text-[10px] font-medium text-white py-[1px] text-center leading-none rounded-full transition-[1s] w-[60%] bg-[#f57820] `}></div>
                                </div>
                            </div>
                    ...
                    <div  data-aos="fade-left" data-aos-duration="1500"  className="experience-cntlr flex order-row lg:py-15 md:py-10 py-10 lg:px-15 md:px-10 px-5">
                        <div className="exp-rgt w-2/3  pl-14 ml-auto order-2">
